...
var PUBLIC_URL = 'https://www.shapertools.com/en-us/'
...
var COPYRIGHT_FOOTER = 'Shaper Tools, inc. all rights reserved'
...
describe('Launch Shaper tools  hompage', () => {
    ...
    var header_logo = '#root > header > div > a > svg.icons__IconLogo-sc-1tmx9b1-2.header__IconLogoStyled-gy0a5i-1.jxPNmX'
    var footer_logo = '#root > footer > div > div > div.footer__DominoCountryContainerStyled-sc-545slg-4.eLhaTF > svg' 
...
describe('Check existence of links buttons on the header and visit link', () => {
    it('should make sure visible header buttons exist and links be visited', () => {
      for (var key in HEADERLINKSDICT) {
...
describe('Show login form', () => {
    var login = '#root > header > div > ul.actionButtons__ActionButtons-sc-1b3egpe-0.beZqfD > li.authentication__LoginButton-sc-13js91g-0.cIliCv > button'
    var sign_in_modal = 'body > div:nth-child(14) > div > div'
...
describe('Login with bad credentials', () => {
    var login = '#root > header > div > ul.actionButtons__ActionButtons-sc-1b3egpe-0.beZqfD > li.authentication__LoginButton-sc-13js91g-0.cIliCv > button'
    var sign_in_modal = 'body > div:nth-child(14) > div > div'
    var username_text_field = '.textInputStyled__TextInputSingleLineStyled-qer98u-0 > .wrapper > input'
    var password_text_field = ':nth-child(3) > .singleLine__TextInputStyled-sc-1t3pv8j-0 > .wrapper > input'
    var fake_username = 'fakeuser@gmail.com'
    var fake_password = 'fakePW1234'
    var error_msg_path = '.common__Message-sc-4aeui8-0'
    var error_msg = 'Your email or password is incorrect'
    var submit = '.verticallyCenteredFlexContainer__VerticallyCenteredFlexContainer-sc-11iru44-0 > .colored'
...
describe('Direct user to Shaper tools store', () => {
    var buy_origin_btn = '.buttonBuyOrigin__ButtonBuyOrigin - sc - 1cy2eis-0 > a > .colored'
...
describe('Visit ShaperHub and view all projects', () => {
    var view_all_projects_btn = '.dqPKFq > a > .colored > .content'
...
describe('Explore filtered projects by submitting a query', () => {
    var view_all_projects_btn = '.dqPKFq > a > .colored > .content'
    var hub_header_container = '.fullWidthContainer__FullWidthContainer-dskl07-0 > .active'
    var search_field = 'form > .singleLine__TextInputStyled-sc-1t3pv8j-0 > .wrapper > input'
    var submit_search = '.search__IconSearchBlue-sc-1wlm1a9-0'
    var query_term = 'walnut'
    
    it('should bring user to the explore tab of ShaperHub and then query for projects matching a keyword', () => {
        //var hub_url = 'https://hub.shapertools.com/search'
        //cy.visit(hub_url)
        cy.get(HEADERLINKSDICT['hub']).click()
        cy.get(view_all_projects_btn, { force: true }).click()
...
describe('Query for nonsensical projects, input validation tests', () =>{
    var hub_base_url = 'https://hub.shapertools.com/search?search='
    var bad_query_terms_dict = {
    ...
    var no_results_found = '.noResultsFound__NoResultsFoundUnconnected-sc-8q61uq-0 > svg'
    it('should reveal a new element with all teams in that league', () => {
        for (var key in bad_query_terms_dict){
